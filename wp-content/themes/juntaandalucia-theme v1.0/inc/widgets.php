...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer bottom Full', 'understrap' ),
				'id'            => 'footerbottomfull',
				'description'   => __( 'Full sized footer bottom widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-bottom-widget  %2$s dynamic-classes">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h2 class="widget-title h3">',
				'after_title'   => '</h2>',
			)
		...
		register_sidebar(
			array(
				...
				'after_widget'  => '</div><!-- .headertop-widget -->',
				'before_title'  => '<h2 class="widget-title h3">',
				'after_title'   => '</h2>',
			)
		);
